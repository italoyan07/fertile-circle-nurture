      ...
      <div className="w-full max-w-sm space-y-8 animate-fade-in">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground font-body text-center">
            Crie sua conta para acessar o Programa FÉRTILE
          </p>
        </div>
        ...
        <button onClick={() => navigate("/login")} className="flex w-full items-center justify-center gap-2 text-sm text-primary font-body hover:underline">
          <ArrowLeft className="h-4 w-4" />Já tenho conta, entrar
        </button>
