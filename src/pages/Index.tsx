  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="mx-auto max-w-lg space-y-4 px-5 pt-5">
        ...
        {/* Habits Progress */}
        <div
          className="rounded-xl border border-border bg-card p-5 shadow-soft animate-fade-in"
        ...
        >
          ...
          <p className="mt-2 text-xs text-muted-foreground font-body">
            {habitsCompleted} de {habitsTotal} concluídos
          </p>
          <Button
            variant="outline"
            size="sm"
            className="mt-3 w-full border-primary/20 text-primary hover:bg-primary/5"
        ...
        >
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-xl border border-border bg-card p-4 shadow-soft transition-all hover:shadow-card hover:border-primary/20"
          >
        ...
        {/* Kiwify CTA */}
        <div
          className="rounded-xl border border-primary/20 bg-primary/5 p-5 animate-fade-in"
          style={{ animationDelay: "0.3s" }}
        >
          <p className="text-xs font-semibold uppercase tracking-wider text-primary font-body mb-1">
            Conteúdo do Programa
          </p>
          <p className="text-sm text-foreground/80 font-body mb-3">
            Acesse suas aulas, materiais e protocolos na plataforma Kiwify.
          </p>
          <a
            href="https://kiwify.com"
            target="_blank"
